...
export class AppComponent implements OnInit, OnDestroy {
  ...
  // backgroundImage: string = 'https://apicskh.evnhanoi.com.vn/media/BannerImage/EMLPNFSFPB.png';
  ...
  constructor(
    ...
    console.log('Menu is' + JSON.stringify(this.menu));
    // this.menu = menu
    ...
    this._translateService.addLangs(['vn', 'en']);
